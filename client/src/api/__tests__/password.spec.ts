...
describe('passwordApi', () => {
    ...
    describe('requestPasswordReset', () => {
        ...
        it('should handle password reset request error', async () => {
            ...
            await expect(passwordApi.requestPasswordReset('nonexistent@example.com')).rejects.toThrow('User not found')
        })
    })
    ...
    describe('resetPassword', () => {
        ...
        it('should handle invalid token error', async () => {
            ...
            await expect(passwordApi.resetPassword('invalid-token', 'newPassword123')).rejects.toThrow('Invalid token')
        })
    })
    ...
    describe('changePassword', () => {
        ...
        it('should handle wrong old password error', async () => {
            ...
            await expect(passwordApi.changePassword('wrongPassword', 'newPassword456')).rejects.toThrow('Current password is incorrect')
        })
    })
})
